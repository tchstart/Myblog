...
public class LocalDateTimeSerializerConfig {
	 ...
	 * 1.配置 MappingJackson2HttpMessageConverter{@link WebMvcConfig#customJackson2HttpMessageConverter()}
	 * 2.重写 WebMVC 的 configureMessageConverters{@link WebMvcConfig#configureMessageConverters(List)}
	 */
	@Bean
	@Primary
