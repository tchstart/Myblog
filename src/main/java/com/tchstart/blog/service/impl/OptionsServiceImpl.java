...
import com.tchstart.blog.constant.OptionEnum;
import com.tchstart.blog.mapper.OptionsMapper;
import com.tchstart.blog.model.entity.OptionsEntity;
...
import com.tchstart.blog.utils.ClassUtils;
...
public class OptionsServiceImpl implements OptionsService {
	...
	public OptionVO get(String key) {
		...
		OptionsEntity optionsEntity = optionsMapper.selectOne(
				Wrappers.lambdaQuery(OptionsEntity.class).eq(OptionsEntity::getOptionKey, key));
